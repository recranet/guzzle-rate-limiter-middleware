...
- Added `$normalize` parameter to `SleepHandler` and `ThrowExceptionHandler` (default: 2000ms)
- Delays >= normalize threshold are rounded up to multiples of the threshold for predictable behavior
